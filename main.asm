...
MAIN		PROC FAR
		...
		CREATABLE:
			...
			MOV edge1, AX				
			MOV edge2, BX
			MOV edge3, DX				;	Kontrolu saglanan ucgen, mevcut en kucuk ucgen olarak degiskenlere atanir.
			JMP L3						;	Stack'ten gerekli degerler zaten cekilmis oldugu icin sonraki adim atlanir.
		L2:	POP BX						;	Kontrol saglanmadigi kosulda (JAE L2) stack'te AX ve BX'in degerleri kalmisti.
			POP AX						;	SP'nin normale donmesi icin bu degerler register'lara cekilir.
		L3:	SUB AX, BX					;	Ic donguye donuldugunde AX'in a yerine a+b olmamasi icin onceden a <- a-b yapilir.
			CMP DI, 0					;	Ic dongunun DI = 0 ise ic dongu sona erer ve dis donguye donulur.
			JE L4
		    DEC DI						;	Ic dongunun sayaci 1 azaltilir.
			JMP IN_LOOP_2				;	DI = 0 olmadigi surece ic dongu doner.
		L4:	ADD SI,2					;	Word tipindeki dizinin sonraki elemanina erismek icin indis 2 arttirilir.
		    LOOP CHECK_TRI				;	Dis dongu, CX = 0 olana kadar (n-2 kez) doner.
